...
%Erster Artikel mitte
%
%Artikeltext
\newcommand{\mitteArtikelEins}{%
Garbe_Mathe.tex%
}
%Artikelfarbe
\newcommand{\mitteArtikelEinsFarbe}{%
klorot%
}
...
%\begin{minipage}{0.47\textwidth}
%\color{\mitteArtikelEinsFarbe}
%\input{\mitteArtikelEins}
%\normalcolor
%\end{minipage}
\end{minipage}
